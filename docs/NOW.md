...
| Step 6–7 shadow parity/retire | **Historical Slice 1–3 evidence · M6 여전히 NO-GO (2026-07-16 재검토 착수, 판정 불변) · Wave A read-model** | Soft dogfood PASS is retained as historical evidence. Current Slice 1–3 authority funcs are disabled/fail-closed; Wave A composites remain on `GET …/mission/read-model`. UI still legacy-read in production (`AGENT_LAB_MISSION_UI_READ_MODEL` default off) — a scratch dev-server dogfood with the flag forced on confirmed HumanInboxPanel renders correctly from the read-model live (first non-mocked UI dogfood), but also reconfirmed the legacy inbox row writer is still required (gate-only items degrade to an unusable placeholder without it). M6 hard delete는 여전히 금지. [journal-first design](./redesign-2026-07/evidence/journal-first-read-projection-design-2026-07-14.md) · [m6-precheck](./redesign-2026-07/evidence/m6-precheck-retire-scope-2026-07-14.md) · [slice-3](./redesign-2026-07/evidence/dual-write-retire-slice-execution-soft-2026-07-14.md) · [ui-read-model-dogfood](./redesign-2026-07/evidence/m6-ui-read-model-dogfood-2026-07-16.md) |
