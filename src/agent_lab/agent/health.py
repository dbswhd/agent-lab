...
def agent_health_row(
    ...
    *,
    ...
    if aid == "kimi":
        from agent_lab.kimi import provider as kimi_provider
    ...
    if aid == "kimi_work":
        ...
        from agent_lab.kimi.control_client import kimi_work_bridge_failure_payload, probe_control
        ...
        if probe_bridge:
            ...
            row["bridge"] = "unknown"
            row["ready"] = row["configured"]
        from agent_lab.kimi.work_loop import kimi_work_loop_phase
