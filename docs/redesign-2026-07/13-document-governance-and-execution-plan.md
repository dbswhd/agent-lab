...
| `09` context engineering      | selector/manifest 완료 · CX1/CX2/CX3 first draft 완료(2026-07-16 — source registry, 6개 activity recipe, provenance/freshness/security+redaction) | CX1~CX3 Human review, CX4(deterministic selector pipeline), producer→ContextItem 어댑터(assembler convergence) | Step 2/4       |
