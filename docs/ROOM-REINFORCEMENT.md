...
> **Phase I (shipped):** Execute worktree M0–M4 — worktree dry-run/merge, isolation override, orphan guard, score KPI (`EXECUTE-WORKTREE-REFORM.md` §11). Live Cursor SDK dry-run: `docs/LIVE-CURSOR-WORKTREE-DRY-RUN.md` + `make live-worktree-dry-run`.
