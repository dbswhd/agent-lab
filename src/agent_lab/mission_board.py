...
from agent_lab.plan_actions import find_dry_run_action, parse_plan_actions
...
def patch_mission_board(folder, updater) -> dict[str, Any]:
...
def clear_checkout(folder) -> dict[str, Any]:
    from pathlib import Path
...
def begin_human_turn(folder, *, human_turn: int) -> dict[str, Any]:
    from pathlib import Path
...
def record_autorun_tick(folder) -> dict[str, Any]:
    from pathlib import Path
...
def sync_turn_budget_from_mission(folder) -> dict[str, Any]:
...
def handle_turn_budget_overflow(folder, *, key: str, message: str) -> None:
    from pathlib import Path
