...
def test_fast_bucket_collection_budget():
    ...
    # 2026-07-08: raised 2650 -> 2700 for TurnPolicy execute-intent + P1 composer dead-code + outcome harvester execute rows.
    assert count <= 2700, f"test-fast bucket grew to {count}; mark slow modules integration"
