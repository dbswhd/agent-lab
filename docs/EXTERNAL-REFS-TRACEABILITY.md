...
| ABSORB-W1 | CC/Codex/Conductor | Workspace card + plan contract (TL;DR/Must-NOT/waves/evidence) | ✅ | `WorkspaceCard.tsx`, `PlanExecutePanel.tsx`, `ROOM_SCRIBE`, `validate_plan_actions_format` soft_issues, [ABSORB-CC-CODEX-2026-07.md](ABSORB-CC-CODEX-2026-07.md), `tests/test_plan_actions_validation.py` | 5모트 유지; P1 Needs-input/steer backlog in ABSORB |
