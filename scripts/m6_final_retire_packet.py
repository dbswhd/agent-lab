...
def build_packet(root: Path, output: Path) -> Path:
    ...
    try:
        with tempfile.TemporaryDirectory(prefix="m6-retire-staging-") as staging_name:
            ...
            _copy_redacted(
                root, "docs/redesign-2026-07/m6-precheck-retire-scope-2026-07-14.md", staging / "reports/m6-precheck.md"
            )
            _copy_redacted(
                root,
                "docs/redesign-2026-07/dual-write-ui-read-model-bounded-cutover-evidence-2026-07-14.md",
