...
| Dedicated Human Inbox resolve panel | 🔶 | API exists; full UI polish in [UI-MIGRATION-GAPS.md](archive/legacy/UI-MIGRATION-GAPS.md) |
| Discuss deterministic harvest → Inbox | 🔶 legacy opt-in | `AGENT_LAB_ORCHESTRATOR_INBOX_HARVEST=1`; MCP-first default — [MCP-FIRST-INBOX.md](./MCP-FIRST-INBOX.md) |
