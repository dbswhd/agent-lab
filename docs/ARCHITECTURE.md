...
| **Baseline (pre hybrid Rust)** | Tag `baseline/pre-hybrid-rust-2026-06-28` · [PACKAGING-BASELINE.md](./archive/legacy/PACKAGING-BASELINE.md) · [HYBRID-RUST-PYTHON-ADR.md](./HYBRID-RUST-PYTHON-ADR.md) |
