...
def _arm_merge_checkpoint(
    ...
    *,
    ...
    """
    from agent_lab.plan_execute import _now, _exec_worktree_from_execution
...
def _record_verify_after_merge(
    ...
    *,
    ...
    from agent_lab.plan_execute import _now, verify_after_merge
...
def _repair_prompt(target: dict[str, Any], *, attempt: int) -> str:
    from agent_lab.plan_execute import MAX_VERIFY_RETRIES
