...
def test_fast_bucket_collection_budget():
    ...
    # 2026-06-28: raised 2075 -> 2130 for vendor package wave (cursor/codex/claude plugins + structure/ratchet smoke).
    assert count <= 2130, f"test-fast bucket grew to {count}; mark slow modules integration"
