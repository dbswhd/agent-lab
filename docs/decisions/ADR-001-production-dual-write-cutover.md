...
Accepted — **Controlled cohort GO (v3d) and Full traffic soak PASS (historical evidence). Slice 1/3 (plan + execution) soft-authority re-enabled 2026-07-23, cohort-gated behind DUAL_WRITE + a non-empty session allowlist. Slice 2 (inbox) stays retired permanently, superseded by the stronger AGENT_LAB_MISSION_AUTHORITY path. Journal-first Wave A read-model composites shipped. M6 hard retire still pending separate Human approval.** Current operational truth is separately recorded in [DOGFOOD-READINESS-STATUS.md](../DOGFOOD-READINESS-STATUS.md): Task 7 live readiness is `OPEN` (`n=0`) and `default_change_authorized=false`; no default routing/authority change follows from this ADR's historical evidence without explicit Human GO.
...
4. 그 외(Room dogfood·fail→repair·merge parity·G3·ActivityQueue·로그/메트릭/검증쿼리)는 **기술 evidence GO**로 유지한다. **2026-07-14 operational cohort v3d는 GO**([cohort run report](../redesign-2026-07/evidence/dual-write-cohort-run-report-2026-07-13.md)). 다음 Human gate는 **Full traffic (bounded cutover + soak)** — [full-traffic runbook](../redesign-2026-07/evidence/dual-write-full-traffic-bounded-cutover-2026-07-14.md). **Legacy writer retire는 soak 완료 후 별도 Human 승인 전까지 금지.**
...
- [dual-read report](../redesign-2026-07/evidence/dual-read-report-2026-07-13.md)
- [live supervisor report](../redesign-2026-07/evidence/dual-read-live-report-2026-07-13.md)
...
- [production route dual-write adapter](../redesign-2026-07/evidence/production-route-dual-write-adapter-2026-07-13.md)
- [dual-write route cohort report](../redesign-2026-07/evidence/dual-write-route-cohort-report-2026-07-13.md)
- [dual-write cutover follow-up (Room dogfood, fail/repair, crash, merge parity)](../redesign-2026-07/evidence/dual-write-cutover-followup-2026-07-13.md)
- [API/daemon process kill→restart recovery](../redesign-2026-07/evidence/process-kill-restart-recovery-2026-07-13.md)
- [ActivityQueue 자동 복구 연결](../redesign-2026-07/evidence/activity-queue-auto-recovery-2026-07-13.md)
- [dual-write controlled cohort runbook](../redesign-2026-07/evidence/dual-write-controlled-cohort-runbook-2026-07-13.md)
- [dual-write 운영 준비 3종 점검](../redesign-2026-07/evidence/dual-write-operational-readiness-check-2026-07-13.md)
- [dual-write 로그/메트릭 + parity 검증 쿼리 (Human Inbox 브리지 gap 발견)](../redesign-2026-07/evidence/dual-write-observability-and-verification-2026-07-13.md)
- [dual-write cutover scope and limitations](../redesign-2026-07/evidence/dual-write-cutover-scope-limitations-2026-07-13.md)
- [dual-write retire Slice 1 — plan soft authority](../redesign-2026-07/evidence/dual-write-retire-slice-plan-soft-2026-07-14.md)
