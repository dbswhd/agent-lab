...
const PATHS: Record<IconName, string> = {
  ...
  gitMerge:
    "M18 16.08V7.12a2 2 0 0 0-1.11-1.79l-1.78-.9A2 2 0 0 0 13 6.18V16M6 9a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM6 21a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM6 9v12",
  ...
  eyeCheck:
    "M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7zM9 12a3 3 0 1 0 6 0 3 3 0 0 0-6 0",
  unlock:
