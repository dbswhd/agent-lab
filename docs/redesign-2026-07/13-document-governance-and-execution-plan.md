...
| `09` context engineering      | selector/manifest 완료 · CX1~CX4 first draft 완료(2026-07-16 — source registry, 6개 activity recipe, provenance/freshness/security+redaction, conflict resolution+dedup) | CX1~CX4 Human review, CX5(repo·artifact targeted retrieval), trim 3~6단계(콘텐츠 압축 파이프라인), producer→ContextItem 어댑터 | Step 2/4       |
