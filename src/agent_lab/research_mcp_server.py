...
def get_playbook(max_chars: int = 4000) -> dict[str, Any]:
    ...
    return read_playbook_summary(_session_folder(), max_chars=cap)
...
def get_kill_switch_status() -> dict[str, Any]:
    ...
    from agent_lab.pipeline_market_read import read_kill_switch, resolve_pipeline_root
