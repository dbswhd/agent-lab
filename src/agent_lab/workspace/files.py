...
from agent_lab.session.paths import SESSIONS_DIR, active_sessions_dir  # noqa: F401
from agent_lab.workspace.roots import resolve_workspace_roots, workspace_label
...
def _session_permissions(run_meta: RunStateLike) -> dict[str, Any]:
    ...
    if isinstance(turns, list):
        for turn in reversed(turns):
            raw_perms = turn.get("permissions")
