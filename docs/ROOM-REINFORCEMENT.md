...
CI: `pytest tests/ -q` + `scripts/smoke_room.py` + `check_worktree_orphans.py` + `score_session.py --json` fixture smoke (LLM/secrets 없음).
...
4. ~~**H-P1** — `score_session` CI~~ ✅ 완료; **H-P2** 벤치 fixture · delegate mock replay는 남음
