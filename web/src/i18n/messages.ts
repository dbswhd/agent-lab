...
const EN = {
  ...
  inboxSyncMode: "Inbox sync",
  inboxSyncModeHint: "When on, pending Human Inbox questions pause discuss rounds.",
...
const KO = {
  ...
  inboxSyncMode: "Inbox sync",
  inboxSyncModeHint: "켜면 Human Inbox 질문 대기 중 discuss 라운드를 일시 중단합니다.",
