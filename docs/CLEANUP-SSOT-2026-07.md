...
| Structure waves | — | [STRUCTURE-REFACTOR-WAVE.md](./STRUCTURE-REFACTOR-WAVE.md) | **B next**, D after 1a |
...
1b      Wave B room/context split + F4 CI guard (run_meta allowlist)
1c      Phase D RoomChat hooks (useRoomWorkbenchLayout…) ← active
