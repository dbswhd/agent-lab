...
| ABSORB-P2-WT | CC/Codex | worktree.yaml baseRef · include · create/remove | ✅ | `worktree_hooks.py`, `execute_isolation.py`, `execute_shared.py`, `execute_worktree.py`, `WorkspaceCard.tsx`, `tests/test_worktree_hooks.py`, [MISSION-BOARD-ADOPTION.md](MISSION-BOARD-ADOPTION.md) §7.3 | Fail-closed create/setup; remove best-effort; no gate bypass |
