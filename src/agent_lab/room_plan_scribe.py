...
from agent_lab.agents.registry import AGENT_IDS, AgentId, available_agents, label
...
def _plan_workflow_post_agent_turn(
    ...
    *,
    ...
    if pw_active and pw_advance and not cancelled:
        from agent_lab.room_agent_invoke import _bind_session_to_run_meta
        from agent_lab.room_session_persist import _session_context
