...
if TYPE_CHECKING:
    from agent_lab.mission_loop import MissionPhase
...
def on_dry_run_complete(folder: Path, execution: dict[str, Any]) -> dict[str, Any] | None:
    ...
    from agent_lab.mission_notepad import append_wisdom_note
...
def _advance_merge_review(folder: Path) -> dict[str, Any]:
    from agent_lab.mission_loop import get_mission_loop, open_block_reason
    from agent_lab.mission_notepad import append_wisdom_note
...
def on_verify_result(
    ...
    *,
    ...
    from agent_lab.mission_loop import _now_iso, get_mission_loop
...
def _on_verify_pass(
    ...
    *,
    ...
    from agent_lab.mission_loop import _mission_dispatch, get_mission_loop
    from agent_lab.mission_notepad import append_wisdom_note
